...
<head>
    ...
    <link rel="stylesheet" href="css/info-qr.css">
    ...
    <header>
        <div class="headersi">
            ...
            <div class="redes roboto">
                <a href="login.php">
                    <!-- <h5 class="inicio-seccion">Iniciar Seccion</h5>
                </a> -->
                    <a href="registro.php">
                        <h5 class="registrarse">Iniciar sesión</h5>
                    </a>
            </div>
        </div>
    </header>
                ...
                <div class="caja-mascota-info-foto-qr-marcota-realizadob">
                    ...
                    <div class="datos-dueño-qr-realizado">
                        ...
                        <div class="caja-datos-dueño-qr-realizado">
                            ...
                            <div class="b-dato-qr-r roboto">10pesos@gmail.com</div>
